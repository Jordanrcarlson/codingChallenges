...
public class CarbonCalculatorTester {
    ...
    public static void testCalcAutoOwnership() {
        int age = 5;
        int result = 0;
        // TODO: uncomment the following code to test your CalcAutoOwnership method
    ...
    public static void testCalcTransit() {
        int kms = 0;
        int result = 0;
        // TODO: uncomment the following code to test your CalcTransit method
    ...
    public static void testCalcCarbonFootprint() {
        int result = 0;
        // TODO: uncomment the following code to test your CalcCarbonFootprint method
    ...
    public static void testCalcCarbonFootprints() {
        // TODO: uncomment the following code to test your CalcCarbonFootprints method
        ...
        displayResults(ArrayOperations.arraysEqual(result1, expected1), "testCalcCarbonFootprints");
        ...
        displayResults(ArrayOperations.arraysEqual(result2, expected2), "testCalcCarbonFootprints");
         
        
    }
    
    public static void testPopulationReport() {
        // TODO: uncomment the following code to test your PopulationReport method
        ...
        System.out.print("is:");
        ArrayOperations.printArray(result1);
        displayResults(ArrayOperations.arraysEqual(result1, expected1), "testPopulationReport");
        ...
        displayResults(ArrayOperations.arraysEqual(result6, expected6), "testPopulationReport");
