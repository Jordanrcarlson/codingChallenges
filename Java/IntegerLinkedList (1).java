...
public class IntegerLinkedList implements IntegerList
{
	...
	public void remove (int value)
	{
		IntegerNode temp = new IntegerNode(value);
			...
			temp = head;
			while(temp.next.getValue() != value){
				temp = temp.next;
			}
	...
	System.out.println("temp.next is " + temp.next.getValue());
			temp.next = temp.next.next;
	...
	System.out.println("temp.next.next.prev is " + temp.next.next.prev.getValue());
